...
import { ScoutNotificationBadge } from "@/components/scout-notification-badge";
          ...
          {sidebarLinks.map((link) => {
            ...
            return (
              ...
              >
                ...
                {link.showBadge && newCount > 0 && (
                  <ScoutNotificationBadge count={newCount} />
                )}
                {isActive && !link.showBadge && (
        ...
        <header className="flex h-16 items-center justify-between border-b border-border bg-white px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              {newCount > 0 && (
                <span className="absolute right-1 top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-gold px-1 text-[9px] font-bold text-charcoal scout-pulse">
                  {newCount}
                </span>
              )}
              {newCount === 0 && (
          ...
          {sidebarLinks.map((link) => {
            ...
            return (
              ...
              >
                ...
                {link.label}
                {link.showBadge && newCount > 0 && (
                  <span className="ml-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-gold px-1 text-[9px] font-bold text-charcoal">
                    {newCount}
                  </span>
                )}
              </Link>
